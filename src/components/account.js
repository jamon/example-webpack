    ...
    return React.createClass({
        ...
        render: function() {
            return <div>
                ...
                <Loading loading={this.state.account.accountNumber === ''}>
                    <BS.Panel header={<Header account={this.state.account}/>}>
                    ...
                    <BS.Panel header='Contact Information'>
                    ...
                    <BS.Panel header='Address Information'>
                        <BS.Row>
                            <BS.Col xs={6}>
